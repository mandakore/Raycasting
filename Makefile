...
#    Updated: 2026/01/31 19:59:04 by atashiro         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= src/main.c \
		  ...
		  src/load_texture.c \
		  src/minimap.c \
		  src/init_raycast.c src/calcurate_wall_height.c src/dda.c src/init_player.c src/move.c src/move_calc.c src/tex.c
OBJS	= $(SRCS:%.c=%.o)
